...
include "HmacSha1.php";
include "Consumer.php";
include "Token.php";
include "Request.php";
include "Util.php";
include "Util/JsonDecoder.php";
include "TwitterOAuthException.php";
...
class TwitterOAuth extends Config
{
    ...
    private function http($method, $host, $path, array $parameters)
    {
        ...
        //echo "Exploded JSON Response from Twitter".'<br><br><br><br>'.$result.'<br>';
        $response = JsonDecoder::decode($result, $this->decodeJsonAsArray);
        //echo '<br><br><br><br>'."Decoded JSON object".'<br><br><br><br><pre>'.print_r($response,1).'</pre><br><br><br><br>';
        $this->response->setBody($response);
        return $response;
    }
    ...
    private function request($url, $method, $headers, $postfields)
    {
        ...
        //echo "JSON Response from Twitter".'<br><br><br><br><pre>'.$response.'</pre><br>';
